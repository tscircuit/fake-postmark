...
export type NewPostmarkEmail = Omit<
  PostmarkEmail,
  "MessageID" | "SubmittedAt" | "ErrorCode" | "StatusMessage"
>
...
export type InputForTemplatedEmail = {
  ...
  | { TemplateId: number; TemplateAlias?: string }
  | { TemplateId?: number; TemplateAlias: string }
)
...
const initializer = combine(databaseSchema.parse({}), (set, get) => ({
  ...
  addTemplatedPostmarkEmail: (
    emailData: InputForTemplatedEmail,
  ): PostmarkEmail => {
